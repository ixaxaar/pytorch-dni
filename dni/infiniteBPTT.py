...
class InfiniteBPTT(Altprop):
  ...
  def __init__(
    ...
    super(InfiniteBPTT, self).__init__()
  ...
  def _forward_update_hook(self):
    def hook(module, input, output):
      ...
      output = self.__format(output, module)
  ...
  def _backward_update_hook(self):
    def hook(module, grad_input, grad_output):
      ...
      self.ctr += 1
      self.cumulative_grad_losses = self.cumulative_grad_losses + loss.item()
      if self.ctr % 1000 == 0:
